...
function Sellerproduct({ user }) {
  ...
  const handleFormproduct = (e) => {
    ...
    formData.append('modelDate', modelDate);
        ...
        <div className="col-sm-12 col-xl-12" style={{ margin: "15px" }}>
          <div className="bg-light rounded h-100 p-4">
            ...
            <form onSubmit={handleFormproduct} enctype="multipart/form-data">
              ...
              <div className="row mb-3">
                <label className="col-sm-2 col-form-label"><b style={airway}>Model/Established Date</b></label>
                <div className="col-sm-10">
                  <input type="date" className="form-control" id="inputEmail3" name="modelDate" value={modelDate} onChange={(e) => setModelDate(e.target.value)} />
                </div>
              </div>
              <div className="row mb-3">
